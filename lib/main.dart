...
import 'package:fluttersqflite/models/Todo_item.dart';
...
class MyApp extends StatelessWidget{
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(title: 'Flutter Demo', theme: ThemeData(primarySwatch: Colors.indigo), home: MyHomePage(title: 'Flutter SQLite Demo App'),);
  }
